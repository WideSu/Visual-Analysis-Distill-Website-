...
ggscatterstats(
  ...
  xlab            = "wage",
  ylab            = "friends num",
  title = "Fig5. People's friends number for different age groups",
)
```

And the strength of connection is not strong as well.
...
ggscatterstats(
  ...
  xlab            = "wage",
  ylab            = "friends num",
  title = "Fig6. People's friends number for different age groups",
)
```
