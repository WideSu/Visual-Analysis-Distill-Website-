...
p2=ggplot(participants_data, aes(x = joviality, y = educationLevel, fill = educationLevel)) +
...
p1=ggplot(data=happy_sorted,
  ...
  annotate("text", x = 4, y = 1, label = "People tend\n to be happier to study with higher education level \n at the start of the study",size=3,color='#4682B4') + 
  theme(plot.title = element_text(size = 12))
library(patchwork)
...
geom_density(alpha=0.2) +
  annotate("text", x = 0.3, y = 0.4, label = "Young people tend\n to be happier",size=3,color='#4682B4') + 
